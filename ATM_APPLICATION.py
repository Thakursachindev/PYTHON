...
atm = ATM()
atm.create_account('user1', 'password1', 1000)
atm.create_account('user2', 'password2', 800)
atm.create_account('user3', 'password3', 1500)
atm.create_account('user4', 'password4', 2000)
atm.create_account('user5', 'password5', 3000)
